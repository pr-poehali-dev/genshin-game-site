...
const services = [
  {
    ...
    desc: 'Полностью откроем карту во всех регионах Тейвата: рельеф, точки телепорта, подземелья.',
    price: 'от 1500 ₽',
  },
  {
    icon: 'Crown',
  ...
  },
  {
    ...
    desc: 'Ежедневные поручения, награды коммисий, лежанка, боссы — держим аккаунт в форме.',
    price: 'от 1400 ₽/нед',
  },
  {
    icon: 'Eye',
