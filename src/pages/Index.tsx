...
const HERO_IMG =
  'https://cdn.poehali.dev/projects/a3463ffc-226b-412b-a57f-123213b47db3/files/cf84edb7-e40a-40ac-83c0-9d9000e6118e.jpg';
...
const reviews = [
  {
    name: 'Артём К.',
    tag: 'AR 58',
    text: 'Открыли карту Фонтейна на 100% — все окулусы, печати и сундуки. Быстро и без вопросов.',
    rating: 5,
  },
  {
    name: 'Виктория М.',
    tag: 'AR 45',
    text: 'Закрыли ивент за пару дней, выбила все награды до конца события. Спасибо, что не пропустила!',
    rating: 5,
  },
  {
    name: 'Дмитрий С.',
    tag: 'AR 60',
    text: 'Беру уход за аккаунтом каждую неделю: коммисии, смола, боссы — всё закрыто, сам только логинюсь за наградами.',
    rating: 5,
  },
  {
    name: 'Елена П.',
    tag: 'AR 52',
    text: 'Собрали примогемы под новый баннер как раз к релизу. Общались через чат, отвечали моментально.',
    rating: 5,
  },
];
